                    ...
                    <div className="relative group">
                      <img 
                        ...
                        onError={(e) => {
                          ...
                          console.log('Failed image URL:', dashboardData.personalizedPromotions?.imageUrl);
                        }}
                      />
                      <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors rounded-lg" />
                    </div>
                    <p className="text-xs text-muted-foreground mt-2">
                      Image source: {dashboardData.personalizedPromotions.imageUrl.startsWith('data:') ? 'Generated by n8n' : 'Fallback image'}
                    </p>
                  </div>
                )}
              </div>
